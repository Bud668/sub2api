export default {
    ...
    riskControl: {
      ...
      cyberPolicyAutoBan: 'Suspend user on first upstream cyber_policy hit',
      cyberPolicyAutoBanHint: 'Independent protective rule for future explicit upstream cyber_policy hits: suspend non-admin users until an administrator restores them; reject subsequent requests from all their keys. False positives are possible. No historical backfill or keyword-triggered suspension under this rule. Threshold/count exclusions do not override it. Admin accounts require manual review; email requires SMTP.',
      cyberPolicyExcludeBan: 'Exclude Cyber Policy Hits from Ban Count',
      cyberPolicyExcludeBanHint: 'Exclude cyber_policy hits and historical rows from threshold-based bans. This does not override the independent first-hit suspension rule above. Logs and notice emails are unaffected.',
    ...
    subscriptions: {
      ...
      adjustSubscription: 'Adjust Dates',
