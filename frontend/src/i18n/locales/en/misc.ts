export default {
  ...
  // Version Badge
  version: {
    budTitle: 'Bud releases',
    budAvailable: 'Update available: v{version}',
    budCurrent: 'Running the latest Bud release',
    budUnconfirmed: 'Latest Bud version not yet confirmed',
    installBud: 'Update Bud release',
    checkWarning: 'Release check failed. The previous result may be stale; refresh later.',
    installerRequired: 'Signed installer or compatible bundle unavailable. No fallback to official binaries.',
    independentUpdate: 'Independent job: backup, brief restart, then verification. Closing this page does not cancel it.',
    reviewFailure: 'Review the deployment job. No automatic database restore, usage reset or security-state clearing.',
    submitUnconfirmed: 'Submission unconfirmed. Checking job status; avoid repeated clicks.',
    reconnecting: 'Reconnecting to confirm update status…',
    reloadPage: 'Update verified · Reload page',
    officialTitle: 'Official releases',
    noticeOnly: 'Notify only',
    officialBase: 'Merged upstream baseline: v{version}',
    officialNew: 'New official v{version} · Release notes',
    officialLatest: 'Latest official v{version} · Release notes',
    officialNoticeHint: 'Checked about every 5 minutes while the admin page is open. Reviewed upstream changes ship as Bud releases.',
    phases: {
      idle: 'No update job',
      downloading: 'Downloading Bud bundle',
      verifying: 'Verifying release signature',
      preparing: 'Backing up and checking security / accounting',
      restarting: 'Switching version · Brief reconnection',
      checking: 'Verifying the new release',
      completed: 'Update completed and verified',
      failed: 'Update incomplete · Primary service untouched',
      recovered: 'Update incomplete · Previous release recovered',
      blocked: 'Operator review required · No automatic downgrade'
    },
