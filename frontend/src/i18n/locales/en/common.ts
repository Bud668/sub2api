export default {
  dynamicQuota: {
    ...
    stageAt: 'Reallocate when upstream usage reaches {percent}%. The date depends on actual usage.', noNextStage: 'No further milestone this cycle',
    stageShort: 'Next allocation · {percent}% upstream', noNextStageShort: 'No next milestone',
    ...
    nextAdjustment: 'Next adjustment: upstream usage reaches {percent}%', allocatedAt: 'Last allocation',
