export default {
  dynamicQuota: {
    ...
    learningHint: 'This is a provisional allocation, not a measured upstream total. Initial base shares use 80% of the budget; the rest follows demand. A personal ceiling is not the allocated allowance.',
