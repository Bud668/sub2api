export default {
  dynamicQuota: {
    ...
    nextAdjustment: 'Next adjustment: upstream usage reaches {percent}%', allocatedAt: 'Last applied adjustment',
    ...
    cycle: 'Subscription quota cycle', used: 'Used this cycle', limit: 'Currently allocated', remaining: 'Available', reserved: 'In-flight reserve',
    synced: 'Latest data sync', confirmed: 'Last confirmed reset', notReset: 'No confirmed reset yet', expected: 'Upstream-reported reset (unconfirmed)',
    resetUnavailable: 'Waiting for upstream sync', resetHint: 'Follows the bound upstream account. A new cycle starts only after its reset is confirmed.',
