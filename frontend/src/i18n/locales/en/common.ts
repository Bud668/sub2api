export default {
  dynamicQuota: {
    ...
    v2AllocationHint: 'Only before a valid estimate, startup uses 10% of the cap, between $20 and $60 and never above the cap; this is not a floor. Share this cycle’s usage-window estimate after excluding the actual 7d threshold reserve. Starting at 2%, allocate at every 1 percentage point while retaining vacant seats. Personal caps always apply; no minimum is guaranteed. Increases have no dollar gate; safety decreases apply immediately. Saving preserves usage.',
    ...
    cardTitle: 'Dynamic weekly quota', rules: 'Rules',
    ...
    cycle: 'Subscription quota cycle', used: 'Used this cycle', limit: 'Current dynamic quota', remaining: 'Available', reserved: 'In flight', increasedBy: 'Quota increased by {amount}', decreasedBy: 'Quota decreased by {amount}',
