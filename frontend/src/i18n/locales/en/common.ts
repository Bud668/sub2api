export default {
  dynamicQuota: {
    ...
    v2AllocationHint: 'Reallocate using verified data at each 10% upstream usage milestone. Toggling preserves usage; allocated amounts are not guaranteed availability.',
    v2LearningHint: 'Upstream capacity is not measured yet. The saved allocation applies until the next milestone with valid evidence.',
