export default {
  dynamicQuota: {
    ...
    debugUsageHint: 'Excluded from dynamic allocation · Existing limits still apply',
    ...
    enableAdminDebugConfirm: 'Convert this subscription for {user} to administrator debug? It will no longer participate in dynamic allocation. Existing usage, bills and pending settlements are preserved; actual consumption still counts against the upstream account. Expiry, original group quotas, model and security limits still apply.',
    ...
    v2AllocationHint: 'Initial allocation and saves during initial learning use the allocation cap. Once a trusted allocation exists, raising the cap does not immediately add quota. Reallocate from valid data at each 10% upstream usage milestone. Adjustments and toggles preserve usage; availability is not guaranteed.',
