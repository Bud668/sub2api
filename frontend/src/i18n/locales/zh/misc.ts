export default {
  ...
  version: {
    budTitle: 'Bud 修改版',
    budAvailable: '可更新至 v{version}',
    budCurrent: '当前已是最新 Bud 版',
    budUnconfirmed: '暂未确认最新 Bud 版本',
    installBud: '更新 Bud 版',
    checkWarning: '版本检查暂时失败，旧结果仅供参考，请稍后刷新。',
    installerRequired: '尚未接入签名安装器，或本版缺少兼容更新包；不会改用官方版本。',
    independentUpdate: '后台独立执行：先备份，再短暂重启并验收；关闭页面不影响更新。',
    reviewFailure: '请核查发布任务；不会自动恢复旧数据库或清空用量、安全状态。',
    submitUnconfirmed: '暂未确认是否提交成功，正在查询任务状态，请勿连续点击。',
    reconnecting: '正在重新连接并确认更新状态…',
    reloadPage: '更新已验收，刷新页面',
    officialTitle: '官方动态',
    noticeOnly: '只提醒，不安装',
    officialBase: '当前合入基线：v{version}',
    officialNew: '官方新版 v{version} · 查看说明',
    officialLatest: '官方最新 v{version} · 查看说明',
    officialNoticeHint: '后台页面打开时约每 5 分钟检查一次。官方更新经审查合入后，以 Bud 版发布。',
    phases: {
      idle: '暂无更新任务',
      downloading: '正在下载 Bud 更新包',
      verifying: '正在验证发布签名',
      preparing: '正在备份并检查安全、账务',
      restarting: '正在切换版本，服务短暂重连',
      checking: '正在验收新版本',
      completed: '更新成功 · 验收通过',
      failed: '更新未完成 · 未切换主服务',
      recovered: '更新未完成 · 已恢复原版本',
      blocked: '更新需人工核查 · 未自动降级'
    },
    currentVersion: '当前版本',
    latestVersion: '最新版本',
    upToDate: '已是最新版本',
