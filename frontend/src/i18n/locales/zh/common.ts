export default {
  dynamicQuota: {
    ...
    absorption: {
      standardAmount: '已确认标准费用', smallException: '小额异常，已自动由站点承担',
      automaticClosed: '已结案 · 未向用户计费',
      automaticUnmetered: '请求中断后未取得完整上游计量，已自动结案，不按预占估算扣款；保留记录和本周期上游容量保护。',
      automaticInvalidReceipt: '计费凭证校验未通过，已保留异常证据并结案，不向用户追扣；需排查凭证异常原因。',
      unknownTotal: '无已核实金额', baseline: '接入前记录',
      title: '站点承担', count: '{n} 条', total: '总金额', knownTotal: '已确认合计', unknownCount: '未核实金额 {n} 条',
