export default {
  dynamicQuota: {
    ...
    stageAt: '上游用量达到 {percent}% 时重新分配；具体日期取决于实际用量。', noNextStage: '本周期暂无下一节点',
    stageShort: '下次分配 · 上游 {percent}%', noNextStageShort: '暂无下一节点',
    ...
    nextAdjustment: '下次调额：上游用量达到 {percent}%', allocatedAt: '最近分配',
    ...
    cycle: '订阅额度周期', used: '本周期已用', limit: '分配额度', remaining: '剩余可用', reserved: '在途预占',
