...
func init() {
	...
	// usersubscriptionDescAdminDebug is the schema descriptor for admin_debug field.
	usersubscriptionDescAdminDebug := usersubscriptionFields[2].Descriptor()
	// usersubscription.DefaultAdminDebug holds the default value on creation for the admin_debug field.
	usersubscription.DefaultAdminDebug = usersubscriptionDescAdminDebug.Default.(bool)
