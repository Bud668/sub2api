...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/dynamic-quotas", h.Admin.Subscription.ListGroupDynamicQuotas)
		groups.GET("/:id/dynamic-quota", h.Admin.Subscription.GetGroupDynamicQuota)
		groups.PUT("/:id/dynamic-quota", h.Admin.Subscription.SaveGroupDynamicQuota)
...
func registerSubscriptionRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	subscriptions := admin.Group("/subscriptions")
	{
		...
		subscriptions.GET("/:id/dynamic-quota/reset", h.Admin.Subscription.DynamicReset)
		subscriptions.POST("/:id/dynamic-quota/reset", h.Admin.Subscription.DynamicReset)
		subscriptions.POST("/absorbed-usage/:request_id/resolve", h.Admin.Subscription.ResolveDynamicAccounting)
		subscriptions.POST("/assign", h.Admin.Subscription.Assign)
		subscriptions.POST("/bulk-assign", h.Admin.Subscription.BulkAssign)
		subscriptions.POST("/:id/extend", h.Admin.Subscription.Extend)
		subscriptions.POST("/:id/admin-debug", h.Admin.Subscription.ConvertToAdminDebug)
		subscriptions.PUT("/:id/admin-debug/quota", h.Admin.Subscription.SaveAdminDebugQuota)
