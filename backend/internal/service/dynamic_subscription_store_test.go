...
func TestDynamicQuotaPostgresAppliedAllowance(t *testing.T) {
	...
	require.Equal(t, 110.02999999, q.LimitUSD, "even a tiny decrease applies before the 30-minute window")
	q = applyCandidate(109.93, false)
	require.Equal(t, 109.93, q.LimitUSD)
	...
	q = applyCandidate(114.92, true)
	require.Equal(t, 109.93, q.LimitUSD)
	q = applyCandidate(114.93, true)
	require.Equal(t, 114.93, q.LimitUSD)
