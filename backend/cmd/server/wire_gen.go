...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	apiKeyService := service.ProvideAPIKeyService(db, apiKeyRepository, userRepository, groupRepository, userSubscriptionRepository, userGroupRateRepository, apiKeyCache, configConfig, billingCacheService, concurrencyService)
	...
	dynamicSubscriptionService := service.ProvideDynamicSubscriptionService(db, accountRepository, openAIQuotaService, subscriptionService, billingCacheService, openAIGatewayService, apiKeyService)
